...
@section('title')
    <title>SIMPEG | Manajemen Jurusan</title>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h6 class="font-weight-normal mb-0">Yuk mulai manajemen data <span
                                    class="text-primary"><b>Jurusan</b></span> kamu bersama
                                kami.
                            </h6>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title">Table data Jurusan</p>
                            {{-- Button Tambah --}}
                            <a href="{{ route('admin.create.jurusan') }}" type="button"
                                        ...
                                        <table id="example" class="display expandable-table" style="width:100%">
                                            ...
                                            @foreach ($jurusan as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.edit.jurusan', $item->id) }}"
                                                            class="link-manage">Edit</a> | <a
                                                            href="{{ route('admin.delete.jurusan', $item->id) }}"
                                                            class="link-manage"
